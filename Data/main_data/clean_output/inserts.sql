-- Auto-generated SQL by clean_permits.py
-- 1) Insert permits (id assigned by DB)
...
INSERT IGNORE INTO permits (name) VALUES ('Athletics Parking');
...
-- This guarantees lot_id and permit_id are the actual DB-assigned keys.
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motorcycle Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Electric Veh Parking'
WHERE l.title = 'Lot 442';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 255';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Electric Veh Parking'
WHERE l.title = 'Lot 255';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Pay Parking'
WHERE l.title = 'Lot 255';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 255';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 255';
...
WHERE l.title = 'Lot 238';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'IU Foundation Parking'
WHERE l.title = 'Headley School Parking';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 424';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Electric Veh Parking'
WHERE l.title = 'Lot 424';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 424';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 100';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletic Parking'
WHERE l.title = 'Lot 102';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 103';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 103';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 104';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 104';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 104';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 108';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 110';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 110';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 110';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking Section E ONLY'
WHERE l.title = 'Lot 110';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 111';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 112';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 112';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 114';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 114';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 115';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 116';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 116';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletic Parking'
WHERE l.title = 'Lot 117';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 117';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 120';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletic Parking'
WHERE l.title = 'Lot 121';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'IU Foundation Parking'
WHERE l.title = 'Lot 122';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking (24 Hr)'
WHERE l.title = 'Lot 123';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 123';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 123';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'This is all of David Baker Ave Street Parking'
WHERE l.title = 'Lot 125';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 125';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 126';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 126';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 127';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 127';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 127';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Metered Parking'
WHERE l.title = 'Lot 127';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 128';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 128';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 128';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Metered Parking'
WHERE l.title = 'Lot 128';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking Section'
WHERE l.title = 'Lot 130';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Athletics Parking'
WHERE l.title = 'Lot 130';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 132';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 132';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 133';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 134';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 136';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 136';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 140';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Pay Lot'
WHERE l.title = 'Lot 140';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 142';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motorcycle Parking'
WHERE l.title = 'Lot 142';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 144';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 146';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 146';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Patient Parking'
WHERE l.title = 'Lot 146';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 148';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 5'
WHERE l.title = 'Lot 148';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 148';
...
WHERE l.title = 'Lot 148';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 3'
WHERE l.title = 'Lot 150';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 150';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 153';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 153';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Parking'
WHERE l.title = 'Lot 154';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 4'
WHERE l.title = 'Lot 156';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 156';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Parking'
WHERE l.title = 'Lot 172';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motor Pool Vehicle Parking'
WHERE l.title = 'Lot 172';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 174';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 174';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 178';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 7'
WHERE l.title = 'Lot 200';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 200';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 208';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 208';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 210';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 212';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 214';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 214';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 214';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'CH6 Parking'
WHERE l.title = 'Lot 216';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 216';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Metered Parking'
WHERE l.title = 'Lot 218';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Metered Parking'
WHERE l.title = 'Lot 218';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 222';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Metered Parking'
WHERE l.title = 'Lot 222';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 226';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 6'
WHERE l.title = 'Lot 226';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 226';
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Student Parking'
WHERE l.title = 'Lot 227';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 227';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 228';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 229';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 6'
WHERE l.title = 'Lot 230';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 230';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 232';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking (24 Hr)'
WHERE l.title = 'Lot 234';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 235';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 235';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 242';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 242';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 257';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 258';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 258';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 259';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 259';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 260';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 260';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 302';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 302';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 310';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 310';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 330';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 330';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 342';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 342';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 343';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 343';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 344';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 344';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 346';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Pay Parking'
WHERE l.title = 'Lot 350';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Pay Parking'
WHERE l.title = 'Lot 350';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking (24 Hr)'
WHERE l.title = 'Lot 354';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 354';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 355';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 355';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 356';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motorcycle Parking'
WHERE l.title = 'Lot 356';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 358';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 358';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 364';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 364';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 366';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 366';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 368';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 402';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motorcycle Parking'
WHERE l.title = 'Lot 402';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 403';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 403';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 404';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 404';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 406';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 409';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 409';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 418';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 420';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 422';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 422';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 423';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Real Estate Office Parking'
WHERE l.title = 'Lot 423';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 426';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 426';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 428';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 428';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 434';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 434';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 436';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 438';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 440';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 440';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 450';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 450';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 451';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 451';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 452';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Metered Parking'
WHERE l.title = 'Lot 452';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 453';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 455';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Pay Parking'
WHERE l.title = 'Lot 456';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 456';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 466';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 466';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 469';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EM Retired Parking'
WHERE l.title = 'Lot 469';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 470';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 470';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 474';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 475';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 476';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Metered Parking'
WHERE l.title = 'Lot 477';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 478';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 478';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 479';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 480';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 480';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 484';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 484';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 488';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 488';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Service Vehicle Parking'
WHERE l.title = 'Lot 504';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 5'
WHERE l.title = 'Lot 508';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 508';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 510';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 512';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Metered Parking'
WHERE l.title = 'Lot 512';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 513';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 513';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 514';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 514';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
WHERE l.title = 'Lot 518';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 1'
WHERE l.title = 'Lot 520';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 520';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 525';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Electric Veh Parking'
WHERE l.title = 'Lot 529';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Visitor Pay Parking (Upper Level Only)'
WHERE l.title = 'Lot 529';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking (Upper Level only)'
WHERE l.title = 'Lot 529';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking (24 Hr)'
WHERE l.title = 'Lot 530';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 530';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 532';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 532';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 536';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 538';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 538';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 540';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 1 & 2'
WHERE l.title = 'Lot 540';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 540';
...
WHERE l.title = 'Lot 547';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 2'
WHERE l.title = 'Lot 548';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 548';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 550';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Campus Housing Parking - Zone 1& 2'
WHERE l.title = 'Lot 550';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 552';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Metered Parking'
WHERE l.title = 'Lot 552';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 554';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 554';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 556';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Metered Parking'
WHERE l.title = 'Lot 556';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 562';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 562';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 566';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Motorcycle Parking'
WHERE l.title = 'Lot 566';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 569';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Accessible Parking'
WHERE l.title = 'Lot 569';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'Reserved Parking'
WHERE l.title = 'Lot 640';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lot 650';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lot 650';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
...
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMS Parking'
WHERE l.title = 'Lots 316 / 318 / 320 / 322 / 324 / 326';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
SELECT l.lot_id, p.permit_id FROM lots l JOIN permits p ON p.name = 'EMP Parking'
WHERE l.title = 'Lots 316 / 318 / 320 / 322 / 324 / 326';
INSERT IGNORE INTO lot_permit (lot_id, permit_id)
